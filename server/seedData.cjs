module.exports = {
  brands: [
    { id: 'honda', name: 'Honda', logo: '/logos/honda.png', models: ['CB125F', 'Wave 110', 'CB190R', 'XR 150L', 'PCX 150'] },
    { id: 'yamaha', name: 'Yamaha', logo: null, models: ['FZ 150', 'YBR 125', 'MT-03', 'NMAX 155', 'Crypton 110'] },
    { id: 'suzuki', name: 'Suzuki', logo: null, models: ['GN 125', 'Gixxer 150', 'Raider R150', 'V-Strom 650'] },
    { id: 'bajaj', name: 'Bajaj', logo: null, models: ['Pulsar NS200', 'Pulsar 150', 'Rouser NS 125', 'Dominar 400'] },
    { id: 'rider', name: 'Rider', logo: null, models: ['Rider 125 FI', 'Rider 150'] },
    { id: 'akt', name: 'AKT', logo: null, models: ['TT 150', 'Dynamic R 150', 'AK 125', 'NKD 125'] }
  ],
  categories: [
